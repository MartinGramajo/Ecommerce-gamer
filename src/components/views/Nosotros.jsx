const Nosotros = () => {
  return (
    <div className="fondo-crear text-white">
    <div className="container">
      <h1 className="text-center">Nosotros</h1>
      <p className="text-center">
        Nosotros somos alumnos de Rolling code, a los cuales se le encomendo la
        tarea de hacer un Ecommerce.
      </p>
      <p className="text-center">
        Acercar el cursor y en mobile hace un touch para conocer a cada uno de los integrantes del grupo.
      </p>
